...
<br/><br/>
<h:commandButton value="Previous" action="#{employController.previous}" rendered="#{employController.previousAvailable}" />
<h:commandButton value="Next" action="#{employController.next}" rendered="#{employController.nextAvailable}" />
        </h:form>
        </center>
    </body>
</html>
