...
<body>
    ...
    <!-- Navigation Bar -->
    <div class="navbar">
        <a href="ShowPatientMedicalHistory.jsf">Show Patient MedicalHistory</a>
        <a href="ShowPatientTests.jsf">Show PatientTests</a>
        <a href="AddMedicalHistory.jsf">Add MedicalHistory</a>
        <a href="Home.jsf">Doctor page</a>
        <a href="PatientHome.jsf">Patient page</a>
    </div>
